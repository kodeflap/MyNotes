...
import com.dlight.mynotes.feature_note.domain.use_cases.NoteUseCases
...
class NoteViewModel @Inject constructor(
    ...
    //function to check events like delete, restore, toggle order selection and sort
    ...
    private fun getNotes(noteOrder: NoteOrder) {
        ...
        getNotesJob?.cancel()
        //for getting new coroutine flow and new job
